...
<div class="w-full flex flex-col gap-4 items-center justify-center rounded-lg shadow-lg px-2 py-4">
    ...
    <button 
        onclick={() => handleLogin()}
        class="w-full flex items-center justify-center h-10 text-xl font-bold bg-blue-100 rounded-md shadow-lg mt-10 py-4 active:bg-blue-500 active:text-white">Login</button>
</div>
